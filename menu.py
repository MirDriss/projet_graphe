...
def menu():
    ...
    while continuer:
        ...
        if step == "selected":
            if display == "matrice":
                print(f"""{Fore.BLUE}Graph {fichier.split("/")[-1]} séléctionné :{Fore.WHITE}""")
